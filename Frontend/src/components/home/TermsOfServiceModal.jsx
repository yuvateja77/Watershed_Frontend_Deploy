...
function TermsOfServiceModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-opacity-70 backdrop-blur-sm z-[9999] flex items-center justify-center p-4 font-sans">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto p-6">
        ...
        <div className="space-y-4 text-gray-700 leading-relaxed text-sm sm:text-base">
          ...
          <h3 className="text-xl font-semibold text-gray-800 pt-2">Data Accuracy and Timeliness:</h3>
          ...
          <h3 className="text-xl font-semibold text-gray-800 pt-2">Purpose of Data:</h3>
          ...
          <h3 className="text-xl font-semibold text-gray-800 pt-2">User Responsibility:</h3>
          ...
          <h3 className="text-xl font-semibold text-gray-800 pt-2">No Endorsement:</h3>
          ...
          <h2 className="text-2xl font-bold text-gray-800 pt-4">Limitation of Liability</h2>
          
          <h3 className="text-xl font-semibold text-gray-800 pt-2">General:</h3>
          ...
          <h3 className="text-xl font-semibold text-gray-800 pt-2">Data Interpretation:</h3>
          ...
          <h3 className="text-xl font-semibold text-gray-800 pt-2">Indemnification:</h3>
          ...
          <h3 className="text-xl font-semibold text-gray-800 pt-2">Modification of These Terms of Use</h3>
          ...
          <h3 className="text-xl font-semibold text-gray-800 pt-2">Acceptance of Agreement</h3>
